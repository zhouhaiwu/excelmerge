...
allxls = ["D:\\excelcs\\工作周报（20181018-20181024)徐兴伟.xlsx",
          ...
          "D:\\excelcs\\工作周报（20181018-20181024)董正威.xlsx"]
#print(allxls[0:2])
# 目标excel
...
first_file_fh1 = open_xls(allxls[1])
first_file_fh2 = open_xls(allxls[2])
...
for sheet in all_sheet_value[value_index]:
    print(type(all_sheet_value[value_index]))
    sheet_index += 1
    value_index += 1
